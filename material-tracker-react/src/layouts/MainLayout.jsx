...
const MainLayout = () => {
  ...
  return (
    ...
    <div className="relative h-screen bg-white dark:bg-gray-900">
      <div className={`grid h-full transition-all duration-300 ${isSidebarCollapsed ? 'grid-cols-[80px_1fr]' : 'grid-cols-[256px_1fr]'}`}>
        <Sidebar />
      ...
      <div
        className={clsx(
            "absolute top-1/3 -translate-y-1/2 h-16 bg-white dark:bg-gray-800 rounded-r-lg shadow-lg flex items-center justify-center transition-all duration-300 ease-in-out z-30 -translate-x-1/2",
