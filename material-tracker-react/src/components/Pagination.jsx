...
const Pagination = ({ currentPage, totalPages, onPageChange }) => {
  ...
  return (
    <div className="flex items-center justify-between mt-4 px-6 py-3 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700"> {/* MODIFIED: Added dark background and border */}
      <p className="text-sm text-gray-700 dark:text-gray-300"> {/* MODIFIED: Added dark text */}
