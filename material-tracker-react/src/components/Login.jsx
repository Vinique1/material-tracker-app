                ...
                <div className="space-y-7">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-12 px-4 bg-white/10 rounded-lg text-white placeholder-white/50 border border-transparent focus:outline-none focus:border-yellow-400 focus:bg-white/20 transition-all duration-300"
                      required
                    />
                  </div>
                  <div>
