...
import StatsCards from './StatsCards'; // Assuming you have this component
...
const MaterialTable = ({ filterKey, filterValue }) => {
    ...
    useEffect(() => {
        ...
        if (filterKey && filterValue) {
            ...
            // Create a query for all documents
    ...
    }, [ADMIN_UID, filterKey, filterValue]); // Rerun effect if filter changes
                ...
                <div className="p-6 border-b border-gray-200 flex justify-between items-center flex-wrap gap-4">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        {!currentUser.isViewer && (
                             <button onClick={handleOpenAddModal} className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 flex items-center space-x-2">
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {filteredMaterials.length > 0 ? filteredMaterials.map(material => {
                                ...
                                <tr>
                                    <td colSpan="8" className="text-center py-10 text-gray-500">No materials found for this filter.</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
